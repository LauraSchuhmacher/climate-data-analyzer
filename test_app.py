...
def test_get_stations_within_radius():
    ...
    [{"id": "GM000010000", "latitude": 47.4211, "longitude": 10.9854, "elevation": 2960.0, "state": None, "name": "ZUGSPITZE", "mindate": "1901-01-01", "maxdate": "2023-12-31"},
    ...
    #Rio de Janeiro
    assert len(get_stations_within_radius(-22.9068, -43.1729, 5000, 5)) == 
    [
    {"id": "BR000047734", "latitude": -22.8751, "longitude": -43.2775, "elevation": 3.0, "state": None, "name": "RIO DE JANEIRO", "mindate": "1910-01-01", "maxdate": "2023-12-31"},
    ...
    #Null Island
    assert len(get_stations_within_radius(0, 0, 10000,2)) == 
    [{"id": "GH000061188", "latitude": 5.6037, "longitude": -0.1870, "elevation": 61.0, "state": None, "name": "ACCRA", "mindate": "1921-01-01", "maxdate": "2023-12-31"},
    ...
    #Nortpole
    assert len(get_stations_within_radius(90.0, 0, 5000, 10)) == 
    [{"id": "SJ000060188", "latitude": 78.2232, "longitude": 15.6267, "elevation": 50.0, "state": None, "name": "LONGYEARBYEN", "mindate": "1910-01-01", "maxdate": "2023-12-31"},
    ...
    #Southpole
    assert len(get_stations_within_radius(-90.0, 0, 5000, 4)) == 
    [{"id": "AQ000890000", "latitude": -89.99, "longitude": 0.00, "elevation": 2835.0, "state": None, "name": "AMUNDSEN-SCOTT", "mindate": "1957-01-01", "maxdate": "2023-12-31"},
